		...
		<div className="h-full library_background">
			<div className="body bg-[#FFFCF0] dark:bg-[#282726]">
				...
				<details>
					...
					<p className="mt-2 italic">I list the title and author of the book, when I started and stopped reading it, and whether I finished it.</p>
				</details>
				<ol>
					{library.map((entry, i) => (
							...
							<div className="grid grid-cols-3 gap-4">
								...
								<div className="col-span-2">
									...
									<div className="library_entry_dates">
										{entry.stopped ? <p>{entry.started} - {entry.stopped}</p> : <p>{entry.started}</p>}
